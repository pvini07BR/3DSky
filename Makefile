...
BUILD		:=	build
SOURCES		:=	source source/scenes source/components source/pages source/thirdparty
DATA		:=	data
INCLUDES	:=	include
...
CFLAGS	:=	-ggdb3 -Wall -O2 -mword-relocations \
			-ffunction-sections \
			$(ARCH)
...
LIBS	:= -lcitro2d -lcitro3d -lcurl -lmbedtls -lmbedx509 -lmbedcrypto -lz -lctru -lm -ljansson
